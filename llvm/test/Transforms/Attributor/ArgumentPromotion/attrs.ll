...
; CHECK-SAME: (%struct.ss* noalias nocapture nofree nonnull byval(%struct.ss) align 8 dereferenceable(12) [[B:%.*]], i32* nocapture nofree nonnull writeonly byval(i32) dereferenceable(4) [[X:%.*]], i32 [[I:%.*]])
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @f(%struct.ss* noalias nocapture nofree nonnull byval(%struct.ss) align 8 dereferenceable(12) [[S]], i32* nocapture nofree readonly byval(i32) [[X]], i32 zeroext 0)
